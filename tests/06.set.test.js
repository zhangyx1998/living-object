...
await test('set with function values', () =>
    new Set([function () {}, function () {}]));

await test('set with mixed values', () =>
    new Set([1, 'b', true, undefined, null, {}, function () {}]));

await test('set with nested sets', () =>
    new Set([1, () => new Set(['a', 'b']), 2, () => new Set(['c', 'd'])]));

await test('set with nested arrays', () =>
    new Set([1, [1, 2, 3], 2, [4, 5, 6]]));

await test('set with mixed values and nested sets', () =>
    new Set([
        1,
        'b',
        true,
