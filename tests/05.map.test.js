...
await test('map with number keys', () =>
    new Map([
        [1, 'a'],
        [2, 'b'],
        [3, 'c'],
...
await test('map with boolean keys', () =>
    new Map([
        [true, 'a'],
        [false, 'b'],
    ]));

await test('map with undefined keys', () =>
    new Map([
        [undefined, 'a'],
        [undefined, 'b'],
    ]));

await test('map with null keys', () =>
    new Map([
        [null, 'a'],
        [null, 'b'],
    ]));

await test('map with object keys', () =>
    new Map([
        [{}, 'a'],
        [{}, 'b'],
    ]));

await test('map with function keys', () =>
    new Map([
        [function () {}, 'a'],
        [function () {}, 'b'],
    ]));

await test('map with mixed keys', () =>
    new Map([
        [1, 'a'],
        ['b', 2],
        [true, 'c'],
...
await test('map with nested maps', () =>
    new Map([
        [
            1,
            () =>
...
await test('map with nested arrays', () =>
    new Map([
        [1, [1, 2, 3]],
        [2, [4, 5, 6]],
    ]));

await test('map with mixed values', () =>
    new Map([
        [1, 'a'],
        ['b', 2],
        [true, 'c'],
